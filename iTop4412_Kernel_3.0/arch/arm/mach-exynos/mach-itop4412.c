...
struct platform_device s3c_device_hian_leds_ctl = {
        .name   = "hian_leds",
        .id             = -1,
};
#endif
...
#ifdef CONFIG_HIAN_DEBUG_CTL
struct platform_device s3c_device_hian_debug_ctl = {
        .name   = "hian_debug",
        .id             = -1,
};
#endif

#ifdef CONFIG_HIAN_ADC_CTL
struct platform_device s3c_device_hian_adc_ctl = {
        .name   = "hian_adc",
        .id             = -1,
};
#endif
...
#ifdef CONFIG_HIAN_DEBUG_CTL
	&s3c_device_hian_debug_ctl,
#endif

#ifdef CONFIG_HIAN_ADC_CTL
	&s3c_device_hian_adc_ctl,
#endif
